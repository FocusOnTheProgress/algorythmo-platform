<script setup>
// algorythmo: plan 0007 M2-f — HR sub-tab deep view.
// One focused mock (anchor + 12-month chart, watermarked) per HR sub-area
// (Contratação / Treinamento / Cultura / Produtividade). These have no live
// upstream report to deep-link into — real KPIs land when the founder unblocks
// the backend.
...
const props = defineProps({
  // One descriptor from mocks/sectors/hr-subtabs.js.
  view: {
    type: Object,
    required: true,
  },
