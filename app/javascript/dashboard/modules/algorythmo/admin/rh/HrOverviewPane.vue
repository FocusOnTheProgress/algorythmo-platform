    ...
    <div class="alg-overview-head">
      <div class="alg-overview-head__left">
        <div class="alg-overview-crumb">
          ...
          <span class="alg-overview-crumb__item" style="color: rgba(255,255,255,0.72)">HR</span>
        </div>
        <h2 class="alg-overview-title">Recursos Humanos</h2>
        <p class="alg-overview-subtitle">
          Contratação, treinamento, cultura e produtividade — o capital humano da empresa em uma leitura.
        </p>
      </div>
    </div>
