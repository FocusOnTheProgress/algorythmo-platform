<script setup>
// algorythmo: plan 0007 M2-f — HR Overview central (D2 + D12).
// Dense data grid: one anchor KPI + one mini sparkline per HR sub-area.
// Mock-backed (hr-overview.js); every card carries the demonstration watermark
// so the mock never reads as a real source of truth.
