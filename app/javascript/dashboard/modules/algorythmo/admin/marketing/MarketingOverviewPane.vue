    ...
    <div class="alg-overview-head">
      <div class="alg-overview-head__left">
        <div class="alg-overview-crumb">
          ...
          <span class="alg-overview-crumb__item" style="color: rgba(255,255,255,0.72)">Marketing</span>
        </div>
        <h2 class="alg-overview-title">Marketing</h2>
        <p class="alg-overview-subtitle">
          CAC, ROAS, leads e retenção — o motor de aquisição e fidelização da empresa.
        </p>
      </div>
    </div>
