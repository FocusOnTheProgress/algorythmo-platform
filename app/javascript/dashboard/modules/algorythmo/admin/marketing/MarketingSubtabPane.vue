<script setup>
// algorythmo: plan 0007 M2-d — Marketing sub-tab deep view.
// One focused mock (anchor + 12-week chart, watermarked) per Marketing
// sub-area (Branding / Redes Sociais / Tráfego / CRM / Retenção). Unlike the
// Commercial sub-tabs, these have no live upstream report to deep-link into —
// real KPIs land when the founder unblocks the backend. Campanhas is handled
// separately (MarketingCampaignsPane.vue) because it composes live routes.
...
const props = defineProps({
  // One descriptor from mocks/sectors/marketing-subtabs.js.
  view: {
    type: Object,
    required: true,
  },
