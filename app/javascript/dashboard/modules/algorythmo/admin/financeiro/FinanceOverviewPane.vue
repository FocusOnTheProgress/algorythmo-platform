    ...
    <div class="alg-overview-head">
      <div class="alg-overview-head__left">
        <div class="alg-overview-crumb">
          ...
          <span class="alg-overview-crumb__item" style="color: rgba(255,255,255,0.72)">Finance</span>
        </div>
        <h2 class="alg-overview-title">Financeiro</h2>
        <p class="alg-overview-subtitle">
          Contas a pagar, receber, fluxo de caixa e margem — a saúde financeira da empresa em uma leitura.
        </p>
      </div>
    </div>
