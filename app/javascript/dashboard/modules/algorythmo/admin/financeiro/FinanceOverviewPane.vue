<script setup>
// algorythmo: plan 0007 M2-f — Finance Overview central (D2 + D12).
// Dense data grid: one anchor KPI + one mini sparkline per Finance sub-area.
// Mock-backed (finance-overview.js); every card carries the demonstration
