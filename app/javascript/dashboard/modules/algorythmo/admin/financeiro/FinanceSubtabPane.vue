<script setup>
// algorythmo: plan 0007 M2-f — Finance sub-tab deep view.
// One focused mock (anchor + 12-week chart, watermarked) per Finance sub-area
// (Contas a Pagar / Contas a Receber / Fluxo de Caixa / Margem / Lucro /
// Planejamento). These have no live upstream report to deep-link into — real
// KPIs land when the founder unblocks the backend.
import { defineAsyncComponent, h, computed } from 'vue';
import { useI18n } from 'vue-i18n';

const props = defineProps({
  // One descriptor from mocks/sectors/finance-subtabs.js.
  view: {
    type: Object,
    required: true,
  },
