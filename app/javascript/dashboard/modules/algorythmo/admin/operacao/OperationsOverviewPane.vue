    ...
    <div class="alg-overview-head">
      <div class="alg-overview-head__left">
        <div class="alg-overview-crumb">
          ...
          <span class="alg-overview-crumb__item" style="color: rgba(255,255,255,0.72)">Operations</span>
        </div>
        <h2 class="alg-overview-title">Operações</h2>
        <p class="alg-overview-subtitle">
          Estoque, reposição, logística e expedição em uma única leitura.
          O setor está estável; reposição puxa atenção.
        </p>
      </div>
    </div>
