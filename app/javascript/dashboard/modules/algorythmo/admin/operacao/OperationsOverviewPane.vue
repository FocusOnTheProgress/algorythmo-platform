<script setup>
// algorythmo: plan 0007 M2-e — Operations Overview central (D2 + D12).
// Dense data grid: one anchor KPI + one mini sparkline per Operations sub-area.
// Mock-backed (operations-overview.js); every card carries the demonstration
