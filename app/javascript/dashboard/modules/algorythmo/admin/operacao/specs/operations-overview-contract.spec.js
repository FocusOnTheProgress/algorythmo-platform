// algorythmo: plan 0007 M2-e — Operations Overview + sub-tab mock contract.
...
import overviewCards from '../../mocks/sectors/operations-overview';
...
describe('operations overview mock — contract', () => {
  it('covers every Operations sub-area exactly once', () => {
...
describe('operations sub-tab mock — contract', () => {
  it('covers every Operations sub-area exactly once (all are mocked deep views)', () => {
