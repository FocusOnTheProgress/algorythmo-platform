<script setup>
// algorythmo: plan 0007 M2-e — Procurement sub-tab deep view.
// One focused mock (anchor + 12-week chart, watermarked) per Procurement
...
const props = defineProps({
  // One descriptor from mocks/sectors/procurement-subtabs.js.
  view: {
    type: Object,
    required: true,
  },
