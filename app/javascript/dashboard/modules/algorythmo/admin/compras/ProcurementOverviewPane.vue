    ...
    <div class="alg-overview-head">
      <div class="alg-overview-head__left">
        <div class="alg-overview-crumb">
          ...
          <span class="alg-overview-crumb__item" style="color: rgba(255,255,255,0.72)">Procurement</span>
        </div>
        <h2 class="alg-overview-title">Compras</h2>
        <p class="alg-overview-subtitle">
          Fornecedores, reposição, CMV e giro — o abastecimento da operação sob controle.
        </p>
      </div>
    </div>
