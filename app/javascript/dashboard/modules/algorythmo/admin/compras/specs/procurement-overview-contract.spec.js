// algorythmo: plan 0007 M2-e — Procurement Overview + sub-tab mock contract.
...
import overviewCards from '../../mocks/sectors/procurement-overview';
import subtabViews from '../../mocks/sectors/procurement-subtabs';

const SUBAREA_IDS = ['fornecedores', 'reposicao', 'custo', 'giro'];
const ALLOWED_GLYPHS = ['▲', '▼', '—'];

describe('procurement overview mock — contract', () => {
  it('covers every Procurement sub-area exactly once', () => {
...
describe('procurement sub-tab mock — contract', () => {
  it('covers every Procurement sub-area exactly once (all are mocked deep views)', () => {
