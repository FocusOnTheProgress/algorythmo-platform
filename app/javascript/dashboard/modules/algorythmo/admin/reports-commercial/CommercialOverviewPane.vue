<script setup>
// algorythmo: plan 0007 M2-c — Commercial Overview central (D2 + D12).
// Dense data grid: one anchor KPI + one mini sparkline per Commercial sub-area.
// Mock-backed (commercial-overview.js); every card carries the demonstration
