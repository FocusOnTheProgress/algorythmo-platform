    ...
    <div class="alg-overview-head">
      <div class="alg-overview-head__left">
        <div class="alg-overview-crumb">
          ...
          <span class="alg-overview-crumb__item" style="color: rgba(255,255,255,0.72)">Commercial</span>
        </div>
        <h2 class="alg-overview-title">Comercial</h2>
        <p class="alg-overview-subtitle">
          Pipeline, conversão, receita e atendimento — o coração comercial da empresa.
        </p>
      </div>
    </div>
