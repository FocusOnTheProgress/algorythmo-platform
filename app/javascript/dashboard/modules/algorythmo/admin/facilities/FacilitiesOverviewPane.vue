<script setup>
// algorythmo: plan 0007 M2-g — Facilities Overview central (D2 + D12).
// Dense data grid: one anchor KPI + one mini sparkline per facility spend area,
// plus a consolidated total. Mock-backed (facilities-overview.js); every card
// carries the demonstration watermark so the mock never reads as real spend.
