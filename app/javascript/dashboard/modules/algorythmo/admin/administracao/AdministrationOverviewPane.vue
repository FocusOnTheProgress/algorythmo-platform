<script setup>
// algorythmo: plan 0007 M2-e — Administration Overview central (D2 + D12).
// Dense data grid: one anchor KPI + one mini sparkline per Administration
// sub-area. Mock-backed (administration-overview.js); every card carries the
